...
$("#btnIncluir").click(function(){
  ...
  $("#cd_tip_sexo").attr("disabled", false);
  $("#cd_estrut_corporal").attr("disabled", false);
  $("#cd_tam_corporal").attr("disabled", false);
  $("#nr_corporal").attr("disabled", false);
  $("#idade_aparente_pessoa").attr("readonly", false);
  $("#cd_tempo_idade").attr("disabled", false);
  $("#qtd_item_neces").attr("readonly", false);
  $("#cd_tip_unid_item").attr("disabled", false);
  $("#cd_tip_clas_item").attr("disabled", false);
